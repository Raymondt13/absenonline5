  ...
  switch (@$_GET['action']) {
    case 'add':
      ...
      if (empty($_POST['id_city'])) {
        ...
        $id_city = mysqli_real_escape_string($connection, $_POST['id_city']);
      }
      ...
      if (empty($error)) {
        ...
        $add = "INSERT INTO building (code, name, id_city, address, building_scanner) VALUES ('$code', '$name', '$id_city', '$address', '')";
...
---------------------------------*/
    case 'update':
      ...
      if (empty($error)) {
        $update = "UPDATE building SET name='$name', id_city='$id_city', address='$address' WHERE building_id='$id'";
