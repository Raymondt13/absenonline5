...
<head>
  ...
  <meta itemprop="image" content="sw-content/gmlogo.png">
...
<div class="loading"><div class="spinner-border text-primary" role="status"></div></div>
  <!-- loader -->
    <div id="loader">
        <img src="' . $base_url . 'sw-mod/sw-assets/img/gmlogo.png" alt="icon" class="loading-icon">
    </div>
    <!-- * loader -->';
...
<!-- App Header -->
    <div class="appHeader bg-danger text-light">
        ...
        <div class="pageTitle">
            <img src="' . $base_url . 'sw-content/gmlogo.png" alt="logo" class="logo">
        </div>Absensi GM Academy
        <div class="right">
    ...
    <div class="modal fade panelbox panelbox-left" id="sidebarPanel" tabindex="-1" role="dialog">
        ...
        echo '
                    ...
                    <div class="icon-box bg-primary">
                      <div class="listview-title mt-1 text-light text-center"><b>MENU USER</b></div></div>
                    <ul class="listview flush transparent no-line image-listview"><hr>
                        <li>
                            <a href="./" class="item">
                                <div class="icon-box bg-warning">
                                    <ion-icon name="home-outline"></ion-icon>
                                </div> <button class="btn btn-warning btn-block " >Beranda</button> 
                            </a>
                        </li>
                        <li>
                            <a href="./present" class="item">
                                <div class="icon-box bg-primary">
                                    ...
                                    <button class="btn btn-primary btn-block " >Kehadiran</button>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="./cuty" class="item">
                                <div class="icon-box bg-secondary">
                                  ...
                                  <button class="btn btn-secondary btn-block " >Cuti</button>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="./history" class="item">
                                <div class="icon-box bg-success">
                                   ...
                                   <button class="btn btn-success btn-block " >History</button>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="profile" class="item">
                                <div class="icon-box bg-primary">
                                    ...
                                    <button class="btn btn-primary btn-block " >Profil</button>
                            </a>
                        </li>
