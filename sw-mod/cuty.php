                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="form-add-cuty" autocomplete="off">
                            ...
                            <div class="form-group basic">
                                <div class="input-wrapper">
                                    <label class="label d-none">Jumlah Cuti</label>
                                    <input type="number" class="form-control d-none" name="cuty_total" value="1" required>
                                    <i class="clear-input"><ion-icon name="close-circle"></ion-icon></i>
                                </div>
                            </div>
                        ...
                        <form id="form-update-cuty" autocomplete="off">
                            ...
                            <div class="form-group basic">
                             ...
                             <div class="form-group basic">
                                <div class="input-wrapper">
                                    <label class="label d-none">Jumlah Cuti</label>
                                    <input type="number" class="form-control d-none" name="cuty_total" id="total" value="" required>
                                    <i class="clear-input"><ion-icon name="close-circle"></ion-icon></i>
                                </div>
                            </div>
