...
if ($mod == '') {
  ...
  <!-- App Capsule -->
        ...
        <div class="section mb-5 p-5">
        <form id="form-login">
                <div class="card">
                <div class="section mt-2 text-center">
                <img src="' . $base_url . 'sw-content/gmlogo.png"  oncontextmenu="return false;" height="120" >
            <br>
            <br>
                <h1><a class="text-primary">LOGIN</h1>
            <h4>Please insert your email and password!</h4></a>
        </div>
                    <div class="card-body pb-1">
                        <div class="form-group basic">
                            <div class="input-wrapper">
                                <label class="label" for="email1"><h4>E-mail</h4></label>
                        ...
                        <div class="form-group basic">
                            <div class="input-wrapper">
                                <label class="label" for="password1"><h4>Password</h4></label>
                                <input type="password" class="form-control" id="password" name="password" placeholder="Your Password">
                                <i class="clear-input"><ion-icon name="close-circle"></ion-icon></i>
                                <br>
                                <button type="submit" class="btn btn-primary btn-block"><ion-icon name="log-in-outline"></ion-icon> Login</button>
                            </div>
                        </div>
                    </div>
                </div>
                <br>
                <div>
                <a class="btn btn-danger btn-block" a  href="admin">
                        <b><i class="metismenu-icon fa fa-user"></i>
                        Login as Admin</b></a>
                </div>
                <div class="form-links mt-2">
                    <div>
                        <a href="registrasi">Create Account</a>
                    </div>
                    <div><a href="forgot" class="text-muted">Forget Password?</a></div>
                </div>
                <!-- <div class="form-button-group  transparent">
                   <a class="btn btn-danger btn-block" a  href="admin">
                        <b><i class="metismenu-icon fa fa-user"></i>
                        Login as Admin</b></a>
                  <a href="oauth/google" class="btn btn-danger btn-block"><ion-icon name="logo-google"></ion-icon> Login with Google</a> -->
                </div>
    ...
    <div class="section">
        ...
        if ($result_absent->num_rows > 0) {
            ...
            echo '
                <div class="col-6">
                    <a href="./absent"><div class="stat-box bg-primary">
                        <div class="title text-white">Absen Masuk</div>
                        <div class="value text-white">Belum absen</div>
                    </div></a>
                </div>
