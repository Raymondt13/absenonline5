...
$time_info = date('H:i');
if ($time_info > '06:30' && $time_info < '11:59') {
    $salam = 'Pagi';
    $time_info_kerja = 'Masuk';
} elseif ($time_info >= '12:00' && $time_info < '15:59') {
    $salam = 'Siang';
    $time_info_kerja = 'Pulang';
} elseif ($time_info >= '16:00' && $time_info < '18:59') {
    $salam = 'Sore';
} else {
    $salam = 'Malam';
}
...
$sw_filter = ereg_replace ("anjing","**", $sw_filter);
$sw_filter = ereg_replace ("bajingan","**", $sw_filter);
return $sw_filter;}
